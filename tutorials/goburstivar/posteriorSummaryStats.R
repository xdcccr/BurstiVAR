...
#   paper_simulation_archive/Study2_Gompertz/code/posteriorSummaryStats.R
#   in the BurstiVAR project.
# Modification: only this provenance header comment was prepended.
