# ------------------------------------------------------------------------------
# Provenance: MLGVAR2605/posteriorSummaryStats.R
#   (original path relative to the BurstiVAR project root)
# Modification: this provenance header comment was prepended.
